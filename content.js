...
const slideContent = [
  ...
  // Diapositiva 12: Es para ti (Guía 12)
  {
    ...
    content: `<ul style=\"list-style-type: none; margin-left: 20px;\">\n
                <li><h2>☑️ ¿Estás listo para dejar de 'apagar incendios' y empezar a construir?</h2></li>
                <li><h2>☑️ ¿Buscas un sistema que te dé control y predictibilidad?</h2></li>
                <li><h2>☑️ ¿Quieres que cada peso invertido en ventas tenga un retorno medible?</h2></li>
              </ul>`,
  },
  ...
  // Diapositiva 13: La Oferta (Guía 13)
  {
    ...
    content: `<h3><strong>Confírma tu inscripción y garantiza tu lugar</strong></h3>
              <p style="margin-top: 20px; font-size: 1.2em;">Escríbenos por Whats App al 55 2523 8312.</p>
              <div class="icon-grid" style="margin-top: 40px;">
              </div>`,
